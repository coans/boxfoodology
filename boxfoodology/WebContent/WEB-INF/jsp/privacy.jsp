<div class="container">
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2 text-justify">
			...
			<p>When you use our Site or Service we collect the personal
				information you give us such as your name, age, address and email
				addresses. When you browse our Site, we also automatically receive
				...
				operating system.</p>
			<p>With your permission, we may send you emails about our Site
				and Services.</p>
			<p>You enter email addresses, Facebook and Twitter
				users to who notifications will be send. It's your obligation not to
				use this service for spam purposes.</p>
			<h4>How do we get your consent?</h4>
			<p>When you provide us with personal information while opening
				an account, we imply that you consent to our collecting it and using
				it for that specific reason only.</p>
			<p>If we ask for your personal information for a secondary
			...
			<p>In general, the third-party providers used by us will only
				...
				to allow them to perform the services they provide to us.</p>
			<p>However, certain third-party service providers, such as
			...
			<p>For these providers, we recommend that you read their privacy
				policies so you can understand the manner in which your personal
				information will be handled by these providers.</p>
			<p>We also use third party analytics tools, such as Google
				Analytics, to help understand use of the Service. Many of these
				tools collect the information sent by your browser as part of a web
				page request, including cookies and your IP address. These analytics
				tools also receive this information and their use of it is governed
				by their privacy policy.</p>
			<p>In particular, remember that certain providers may be located
			...
			<p>Once you leave our website or are redirected to a third-party
				website or application, you are no longer governed by this Privacy
				Policy or our website's Terms of Service.</p>
			<h4>Links</h4>
			<p>When you click on links on our Site, they may direct you away
			...
			<p>To protect your personal information, we take reasonable
				...
				destroyed.</p>
			<h4>Cookies</h4>
			<p>When you use our Service, we may send one or more
				cookies to your computer to uniquely identify your browser and let
				us help you log in faster and enhance your navigation through the
				site.</p>
			...
			<p>If our Site is acquired or merged with another company, your
				information may be transferred to the new owners so that we may
				continue to provide support to you.</p>
		</div>
	</div>
</div>
