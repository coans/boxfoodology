...
@ComponentScan("com.boxfoodology")
@PropertySources({
	@PropertySource("classpath:application.properties"),
	@PropertySource(value = "file:${catalina.home}/config/boxfoodology/application.properties", ignoreResourceNotFound = true)
})
@EnableJpaRepositories(basePackages = "com.boxfoodology.db.repository")
